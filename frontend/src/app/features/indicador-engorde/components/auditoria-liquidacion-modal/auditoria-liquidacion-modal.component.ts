// frontend/src/app/features/indicador-engorde/components/auditoria-liquidacion-modal/auditoria-liquidacion-modal.component.ts
import { Component, EventEmitter, Input, Output, ChangeDetectionStrategy } from '@angular/core';
import { ConfirmDialogService } from '../../../../shared/services/confirm-dialog.service';
import { CommonModule } from '@angular/common';
import { FormsModule } from '@angular/forms';
import { exportarAoaExcel } from '../../../../shared/utils/excel/exportar-tabla-excel.funcion';
import { IndicadorEngordeService } from '../../services/indicador-engorde.service';
...
export class AuditoriaLiquidacionModalComponent {
  ...
  constructor(private confirmDialog: ConfirmDialogService, private svc: IndicadorEngordeService) {}
