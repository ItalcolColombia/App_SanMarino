// frontend/src/app/features/indicador-engorde/components/liquidacion-reporte/liquidacion-reporte.component.ts
...
export class LiquidacionReporteComponent {
  ...
  diasEngorde(ind: IndicadorEngordeDto): number {
   ...
   */
  ajusteAves(ind: IndicadorEngordeDto): number {
  ...
  porcentajeAjuste(ind: IndicadorEngordeDto): number {
  ...
  produccionKiloEnPie(ind: IndicadorEngordeDto): number {
  ...
  totalKilosCliente(ind: IndicadorEngordeDto): number | null {
