...
import {
  ...
  GuiaGeneticaEngordeDetalleInputDto,
  GuiaGeneticaEngordeImportResultDto,
  GuiaGeneticaEngordeService
} from '../guia-genetica-engorde.service';
import { CountryFilterService } from '../../../../core/services/country/country-filter.service';

type SexoTab = 'mixto' | 'hembra' | 'macho';

@Component({
  selector: 'app-guia-genetica-engorde-page',
  standalone: true,
  imports: [CommonModule, FormsModule, FontAwesomeModule, SidebarComponent],
  templateUrl: './guia-genetica-engorde-page.component.html',
  changeDetection: ChangeDetectionStrategy.Eager,
  styleUrls: ['./guia-genetica-engorde-page.component.scss']
})
export class GuiaGeneticaEngordePageComponent implements OnInit, OnDestroy {
  faDna = faDna;
  faUpload = faUpload;
  faPlus = faPlus;
  faSpinner = faSpinner;
  ...
  tab: SexoTab = 'mixto';
  filas: GuiaGeneticaEngordeDetalleDto[] = [];
  ...
  get paginatedFilas(): GuiaGeneticaEngordeDetalleDto[] {
  ...
  importBusy = false;
  importResult: GuiaGeneticaEngordeImportResultDto | null = null;

  manualOpen = false;
  manualSexo: SexoTab = 'mixto';
  manualEstado: 'active' | 'inactive' = 'active';
  manualRows: GuiaGeneticaEngordeDetalleInputDto[] = [];
  manualBusy = false;
  ...
  editForm: GuiaGeneticaEngordeDetalleInputDto = this.filaVacia();
  ...
  constructor(
    private svc: GuiaGeneticaEngordeService,
  ...
  filaVacia(): GuiaGeneticaEngordeDetalleInputDto {
    return {
      dia: 1,
      pesoCorporalG: 0,
      gananciaDiariaG: 0,
  ...
  private mapDetalleToInput(r: GuiaGeneticaEngordeDetalleDto): GuiaGeneticaEngordeDetalleInputDto {
    return {
      dia: Number(r.dia),
      pesoCorporalG: Number(r.pesoCorporalG),
      gananciaDiariaG: Number(r.gananciaDiariaG),
  ...
  openEditRow(r: GuiaGeneticaEngordeDetalleDto): void {
    this.error = null;
  ...
  openDeleteRow(r: GuiaGeneticaEngordeDetalleDto): void {
    this.error = null;
