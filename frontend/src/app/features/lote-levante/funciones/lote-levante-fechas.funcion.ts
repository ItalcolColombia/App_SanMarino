/**
 * Helpers puros de fecha/número para el módulo lote-levante.
 *
 * Extraídos de `modal-create-edit.component.ts` sin cambiar comportamiento: mismas reglas de
 * normalización de fechas (mm/dd, dd/mm, ISO, Date) y de parseo numérico. Funciones puras: sin
 * `this`, sin DI, sin estado de Angular.
 */

/** Convierte cualquier valor a número o null (vacío/NaN → null). */
