...
import { PanelTareasCampoComponent } from '../gestion-veterinaria/components/panel-tareas-campo/panel-tareas-campo.component';
import { environment } from '../../../environments/environment';

@Component({
  selector: 'app-home',
  standalone: true,
  imports: [RouterModule, FontAwesomeModule, PanelPendientesFirmaComponent, PanelPendientesVacunacionComponent, PanelTareasCampoComponent],
