...
@Component({
  selector: 'app-seguimiento-aves-engorde-panama-list',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class SeguimientoAvesEngordePanamaListComponent implements OnInit {
  readonly SIN_GALPON = '__SIN_GALPON__';
  readonly filterDataUrl = `${environment.apiUrl}/SeguimientoAvesEngordePanama/filter-data`;
  ...
  constructor(
    ...
    private segSvc: SeguimientoAvesEngordePanamaService,
