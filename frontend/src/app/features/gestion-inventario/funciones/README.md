...
| `conceptos-catalogo.funcion.ts` | `conceptosUnicos` / `conceptoEfectivo` / `normalizarConcepto`: opciones del desplegable **Concepto**, con una sola etiqueta por concepto aunque el catálogo lo traiga con distinta capitalización. |
