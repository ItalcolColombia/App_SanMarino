...
import { MoverResult } from '../../nucleo/services/nucleo.service';
...
export class GalponService {
  ...
  /** Mover el galpón (y todo su contenido) a otro núcleo/granja. */
  mover(galponId: string, granjaDestinoId: number, nucleoDestinoId: string): Observable<MoverResult> {
    return this.http.post<MoverResult>(`${this.baseUrl}/${galponId}/mover`, {
      galponId, granjaDestinoId, nucleoDestinoId
    });
  }
