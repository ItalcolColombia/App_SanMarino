...
- [x] V1.10 Estado por registro: columna con badge, fila roja, alarma y modal de pendientes al entrar al lote (levante, producción y engorde; reproductora ya lo tenía)
...
- [x] V1.14 `dotnet build` 0 err · `dotnet test` 2574 ✓ · `yarn build` sin errores TS ni de plantilla · gate de paridad multipaís en 0 para Ecuador y Panamá · smoke de 11 pasos con el flag ENCENDIDO (encontró 2 bugs, corregidos) y base restituida al baseline
