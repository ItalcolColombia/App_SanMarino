...
class _LoginScreenState extends State<LoginScreen> {
  final _email = TextEditingController(text: 'carolina@sanmarino.co');
  ...
  Future<void> _entrar() async {
    ...
    // TODO: reemplazar por AuthService.login() — el backend devuelve
    // el JSON con modulos[] y loteIds[] según rol y granjas asignadas.
    widget.onLogin(Usuario(
      id: 1, nombre: 'Carolina Méndez', email: _email.text,
      cargo: 'Supervisora', granja: 'San Marino Buga', pais: 'colombia',
      modulos: const [ModuloSeguimiento.levante, ModuloSeguimiento.produccion],
      loteIds: const [1, 3, 5],
    ));
  }
