        ...
        return AnimatedBuilder(
          ...
          builder: (_, __) => Container(
            ...
            decoration: BoxDecoration(
              ...
              shape: BoxShape.circle,
              boxShadow: [BoxShadow(
                color: AppColors.orange500.withValues(alpha: 0.18 - (_c.value * 0.10)),
                blurRadius: 0,
...
class AmbientDot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width: 10, height: 10,
      decoration: BoxDecoration(
        color: offline ? AppColors.ink700 : AppColors.orange500,
        shape: BoxShape.circle,
...
class ConnectionChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final (bg, fg, label) = switch (sync.calidad) {
      ...
      _ => (AppColors.orange50, AppColors.orange700, '${sync.pendientes} pendientes'),
    };
