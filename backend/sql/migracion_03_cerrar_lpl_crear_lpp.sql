-- =============================================================================
-- MIGRACIÓN 03: Cerrar LPL con edad>=26 y crear UN LPP (hembras + machos)
...
-- 2. Cerrar LPL
-- 3. Crear UN solo LPP con nombre P-{base_nombre}, aves_h y aves_m
...
BEGIN
  ...
  FOR r IN (
    SELECT lpl.lote_postura_levante_id, lpl.lote_nombre, lpl.granja_id, lpl.nucleo_id, lpl.galpon_id,
           lpl.regional, lpl.fecha_encaset, lpl.hembras_l, lpl.machos_l, lpl.aves_h_inicial, lpl.aves_m_inicial,
           lpl.peso_inicial_h, lpl.peso_inicial_m, lpl.unif_h, lpl.unif_m, lpl.mort_caja_h, lpl.mort_caja_m,
           lpl.raza, lpl.ano_tabla_genetica, lpl.linea, lpl.tipo_linea, lpl.codigo_guia_genetica, lpl.linea_genetica_id,
           lpl.tecnico, lpl.mixtas, lpl.peso_mixto, lpl.aves_encasetadas, lpl.edad_inicial, lpl.lote_erp, lpl.estado_traslado,
  ...
  LOOP
    ...
    nombre_produccion := 'P-' || base_nombre;
    uid := COALESCE(r.updated_by_user_id, r.created_by_user_id);

    -- Un solo LPP con hembras y machos (nombre P-{base}, sin -H/-M)
    INSERT INTO public.lote_postura_produccion (
      ...
      nombre_produccion, r.granja_id, r.nucleo_id, r.galpon_id, r.regional, r.fecha_encaset,
      ...
      r.lote_postura_levante_id, aves_h, aves_m, aves_h, aves_m,
