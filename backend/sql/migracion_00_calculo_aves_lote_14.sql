-- =============================================================================
-- MIGRACIÓN 00: Cálculo de aves actuales para lote 14 (SOLO CONSULTAS - no modifica datos)
...
-- 1) Datos del lote 14 (origen)
SELECT '1. Lote 14 (tabla lotes)' AS paso;
...
SELECT '3. Registros en seguimiento_lote_levante para lote 14' AS paso;
...
SELECT '4. Sumas de descuentos desde seguimiento_lote_levante (lote 14)' AS paso;
SELECT
