...
public class SeguimientoAvesEngordePanamaController : ControllerBase
{
    ...
    /// <summary>
    /// Crear un nuevo registro diario (Panamá).
    /// Incluye campos específicos de Panamá: qqMixtas, qqHembras, qqMachos (quintales de alimento).
    /// </summary>
    [HttpPost]
    ...
    /// <summary>
    /// Editar un registro diario (Panamá).
    /// Incluye campos específicos de Panamá: qqMixtas, qqHembras, qqMachos (quintales de alimento).
    /// </summary>
    [HttpPut("{id:int}")]
    [ProducesResponseType(typeof(SeguimientoLoteLevanteDto), StatusCodes.Status200OK)]
    ...
    /// <summary>Eliminar un registro diario (Panamá).</summary>
    [HttpDelete("{id:int}")]
