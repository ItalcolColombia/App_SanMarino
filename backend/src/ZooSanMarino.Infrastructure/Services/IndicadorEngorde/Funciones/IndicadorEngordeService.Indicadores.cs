...
// Partial de IndicadorEngordeService.
using Microsoft.EntityFrameworkCore;
using ZooSanMarino.Application.DTOs;

namespace ZooSanMarino.Infrastructure.Services;

public partial class IndicadorEngordeService
{
    public async Task<IEnumerable<IndicadorEngordeDto>> CalcularIndicadoresAsync(IndicadorEngordeRequest request)
    {
        try
        {
            var lotes = await ObtenerLotesAsync(request);
            var resultados = new List<IndicadorEngordeDto>();
    ...
    private async Task<List<LoteInfo>> ObtenerLotesAsync(IndicadorEngordeRequest request)
    {
        try
        {
    ...
    private async Task<IndicadorEngordeDto?> CalcularIndicadorPorLoteAsync(LoteInfo lote, IndicadorEngordeRequest request)
    {
        ...
        return new IndicadorEngordeDto(
            lote.GranjaId,
            lote.GranjaNombre,
            loteId,
            lote.LoteNombre,
