...
public partial class IndicadorEngordeService
{
    ...
    public async Task<LiquidacionPeriodoDto> CalcularLiquidacionPeriodoAsync(
        ...
        int? granjaId = null)
    {
        var request = new IndicadorEngordeRequest(
            GranjaId: granjaId,
            FechaDesde: null,
            FechaHasta: null,
    ...
    public async Task<IEnumerable<IndicadorEngordeDto>> ObtenerLotesCerradosAsync(
        DateTime fechaDesde,
        DateTime fechaHasta,
        int? granjaId = null,
        bool soloCerrados = true)
    {
        ...
        var requestAbierto = new IndicadorEngordeRequest(
            GranjaId: granjaId,
