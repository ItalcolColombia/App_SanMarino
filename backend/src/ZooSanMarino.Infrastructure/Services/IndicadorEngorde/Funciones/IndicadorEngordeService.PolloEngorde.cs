...
public partial class IndicadorEngordeService
{
    ...
    private async Task<IndicadorEngordeDto?> CalcularIndicadorLoteAveEngordeAsync(
        LoteAveEngorde lote,
        DateTime? fechaDesde,
        DateTime? fechaHasta,
        ...
        bool usarCierreAdministrativo = false)
    {
        ...
        var rows = await _context.Database
            .SqlQueryRaw<IndicadorEngordeRow>(
    ...
    private async Task<IndicadorEngordeDto?> CalcularIndicadorLoteReproductoraAveEngordeAsync(
