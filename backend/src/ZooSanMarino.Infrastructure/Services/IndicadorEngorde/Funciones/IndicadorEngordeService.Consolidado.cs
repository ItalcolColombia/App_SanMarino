...
{
    public async Task<IndicadorEngordeConsolidadoDto> CalcularConsolidadoAsync(IndicadorEngordeRequest request)
    {
        ...
        {
            return new IndicadorEngordeConsolidadoDto(
                ...
                Enumerable.Empty<IndicadorEngordeDto>() // IndicadoresPorGranja
            );
        }
