...
public partial class TicketService
{
    ...
    {
        var filas = await ProyectarFilasIndicadorAsync(await AplicarFiltroTableroAsync(filtro, vistaSoloLectura: true), ct);
    ...
    {
        var query = await AplicarFiltroTableroAsync(filtro, vistaSoloLectura: true);
