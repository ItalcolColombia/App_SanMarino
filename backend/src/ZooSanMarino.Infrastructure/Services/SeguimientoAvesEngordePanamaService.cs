...
public class SeguimientoAvesEngordePanamaService : ISeguimientoAvesEngordePanamaService
{
    private readonly ZooSanMarinoContext _ctx;
    private readonly ICurrentUser _current;

    public SeguimientoAvesEngordePanamaService(ZooSanMarinoContext ctx, ICurrentUser current)
    {
        _ctx = ctx;
        _current = current;
    }
    ...
    {
        var entity = await _ctx.SeguimientoDiarioAvesEngordePanama.AsNoTracking()
    ...
    {
        var query = _ctx.SeguimientoDiarioAvesEngordePanama.AsNoTracking();
    ...
    {
        var entity = new SeguimientoDiarioAvesEngordePanama
        {
        ...
        _ctx.SeguimientoDiarioAvesEngordePanama.Add(entity);
    ...
    {
        var entity = await _ctx.SeguimientoDiarioAvesEngordePanama
        ...
        entity.QqMixtas = dto.QqMixtas;
        entity.QqHembras = dto.QqHembras;
        entity.QqMachos = dto.QqMachos;

        _ctx.SeguimientoDiarioAvesEngordePanama.Update(entity);
        await _ctx.SaveChangesAsync();
        return MapToDto(entity);
    }
    ...
    {
        var entity = await _ctx.SeguimientoDiarioAvesEngordePanama.FirstOrDefaultAsync(x => x.Id == id);
        if (entity is null) return false;
        _ctx.SeguimientoDiarioAvesEngordePanama.Remove(entity);
        await _ctx.SaveChangesAsync();
        return true;
    }

    private static SeguimientoLoteLevanteDto MapToDto(SeguimientoDiarioAvesEngordePanama e)
    {
