...
// La implementación vive repartida por responsabilidad en 'IndicadorEngorde/Funciones/':
...
// Application/Calculos/IndicadorEngordeCalculos.cs.
...
public partial class IndicadorEngordeService : IIndicadorEngordeService
{
    ...
    public IndicadorEngordeService(ZooSanMarinoContext context, ICurrentUser currentUser)
    {
        _context = context;
    ...
    private static decimal CalcularConversionAjustada(decimal conversion, decimal pesoPromedio, decimal pesoAjuste, decimal divisorAjuste)
        => IndicadorEngordeCalculos.ConversionAjustada(conversion, pesoPromedio, pesoAjuste, divisorAjuste);
