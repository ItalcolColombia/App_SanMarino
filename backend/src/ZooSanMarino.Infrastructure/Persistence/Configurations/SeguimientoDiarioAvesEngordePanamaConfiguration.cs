...
public class SeguimientoDiarioAvesEngordePanamaConfiguration : IEntityTypeConfiguration<SeguimientoDiarioAvesEngordePanama>
{
    public void Configure(EntityTypeBuilder<SeguimientoDiarioAvesEngordePanama> b)
    {
        b.ToTable("seguimiento_diario_aves_engorde_panama");
        b.HasKey(x => x.Id);
        ...
        // Campos específicos de Panamá
        b.Property(x => x.QqMixtas).HasColumnName("qq_mixtas").HasPrecision(12, 3);
        b.Property(x => x.QqHembras).HasColumnName("qq_hembras").HasPrecision(12, 3);
        b.Property(x => x.QqMachos).HasColumnName("qq_machos").HasPrecision(12, 3);

        b.HasIndex(x => x.LoteAveEngordeId).HasDatabaseName("ix_seguimiento_diario_aves_engorde_panama_lote");
        b.HasIndex(x => x.Fecha).HasDatabaseName("ix_seguimiento_diario_aves_engorde_panama_fecha");
