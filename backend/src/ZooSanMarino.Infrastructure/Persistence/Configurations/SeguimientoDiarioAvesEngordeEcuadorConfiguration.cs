...
public class SeguimientoDiarioAvesEngordeEcuadorConfiguration : IEntityTypeConfiguration<SeguimientoDiarioAvesEngordeEcuador>
{
    public void Configure(EntityTypeBuilder<SeguimientoDiarioAvesEngordeEcuador> b)
    {
        b.ToTable("seguimiento_diario_aves_engorde_ecuador");
        b.HasKey(x => x.Id);
