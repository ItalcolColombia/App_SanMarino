// src/ZooSanMarino.Infrastructure/Persistence/Configurations/LotePosturaProduccionConfiguration.cs
...
public class LotePosturaProduccionConfiguration : IEntityTypeConfiguration<LotePosturaProduccion>
{
    public void Configure(EntityTypeBuilder<LotePosturaProduccion> b)
    {
        b.ToTable("lote_postura_produccion", schema: "public");
        b.HasKey(x => x.LotePosturaProduccionId);

        b.Property(x => x.LotePosturaProduccionId).HasColumnName("lote_postura_produccion_id").ValueGeneratedOnAdd();
        ...
        b.Property(x => x.PesoHuevo).HasColumnName("peso_huevo").HasColumnType("numeric(18,4)");
        ...
        b.HasIndex(x => x.LoteId).HasDatabaseName("ix_lote_postura_produccion_lote");
        b.HasIndex(x => x.LotePosturaLevanteId).HasDatabaseName("ix_lote_postura_produccion_levante");

        b.ToTable(t =>
        {
            t.HasCheckConstraint(
                "ck_lpp_nonneg_counts",
