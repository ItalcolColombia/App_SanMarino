// Partial de la migracion FnAjusteCuadreAlimentoEngordeV17: SOLO las constantes SQL, para que el
// archivo principal se pueda leer. Cada constante es el archivo de backend/sql/ TAL CUAL (espejo),
// salvo las dos "_Previa", que son la version anterior reconstruida para el Down.

#nullable disable

namespace ZooSanMarino.Infrastructure.Migrations
{
    public partial class FnAjusteCuadreAlimentoEngordeV17
    {
        /// <summary>
        /// v17 - la fn diaria de engorde lee los dos tipos del ajuste de cuadre en sus 5 CTE.
        /// Espejo exacto de backend/sql/fn_seguimiento_diario_engorde.sql.
        /// </summary>
        private const string FnSeguimientoDiarioEngordeV17 = """
-- =============================================================================
...
""";
        ...
        /// <summary>
        /// v16a - la version anterior, para el Down. Copiada verbatim del archivo tal como
        /// estaba antes del cambio (migracion 20260818060000).
        /// </summary>
...
""";
        ...
        /// <summary>
        /// fn_cuadre_alimento_engorde con el ajuste de cuadre contado en `mov_post`.
        /// Espejo exacto de backend/sql/fn_cuadre_alimento_engorde.sql.
        /// </summary>
        private const string FnCuadreAlimentoEngordeConAjuste = """
-- =============================================================================
...
""";
        ...
        /// <summary>
        /// La version previa del cuadre, para el Down.
        /// </summary>
        private const string FnCuadreAlimentoEngordePrevia = """
-- =============================================================================
-- fn_cuadre_alimento_engorde(p_company_id INT DEFAULT NULL)
--
-- El INVARIANTE del alimento de pollo engorde, por galpón:
