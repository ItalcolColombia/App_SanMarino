...
namespace ZooSanMarino.Infrastructure.Migrations
{
    ...
    /// de la v11, dejando el dato GUARDADO y la GRILLA en el mismo numero.
    /// <para>
    ...
    /// </para>
    /// <para>
    /// Debe correr DESPUES de <c>20260730090000_FnSeguimientoEngordeV11AperturaSinCicloAnterior</c>:
    /// lee los valores de esa version de la funcion.
    /// </para>
    /// Plan: fase_de_desarrollo/fix_apertura_alimento_ciclo_anterior_plan.md
    /// </summary>
    public partial class RecalcularSaldoAlimentoEngordeV11 : Migration
    {
        private const string BackupTable = "_backup_saldo_alimento_engorde_v11";
