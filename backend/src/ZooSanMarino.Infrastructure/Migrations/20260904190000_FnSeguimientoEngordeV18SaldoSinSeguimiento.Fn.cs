// Partial de la migracion FnSeguimientoEngordeV18SaldoSinSeguimiento: SOLO las constantes SQL, para
// que el archivo principal se pueda leer. `...V18` es backend/sql/fn_seguimiento_diario_engorde.sql
// TAL CUAL (espejo); `...V17` es la version que habia antes, verbatim, para el Down.

#nullable disable

namespace ZooSanMarino.Infrastructure.Migrations
{
    public partial class FnSeguimientoEngordeV18SaldoSinSeguimiento
    {
        /// <summary>
        /// v18 - el saldo de la grilla se acota con el mismo piso que las filas, asi un lote sin
        /// seguimientos deja de heredar todo el alimento historico del galpon.
...
""";
        ...
        /// <summary>La v17 verbatim, para el <c>Down</c>.</summary>
