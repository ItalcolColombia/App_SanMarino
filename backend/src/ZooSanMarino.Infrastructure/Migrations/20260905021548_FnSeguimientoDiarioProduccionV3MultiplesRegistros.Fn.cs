// Partial de 20260905021548_FnSeguimientoDiarioProduccionV3MultiplesRegistros: SQL verbatim.
// V3 = backend/sql/fn_seguimiento_diario_produccion.sql (espejo, este commit); V2 = version previa para el Down.

namespace ZooSanMarino.Infrastructure.Migrations
{
    public partial class FnSeguimientoDiarioProduccionV3MultiplesRegistros
    {
        private const string FnV3 = """
-- ═══════════════════════════════════════════════════════════════════════════════════════
