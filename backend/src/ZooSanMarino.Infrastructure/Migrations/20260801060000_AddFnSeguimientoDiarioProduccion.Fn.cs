// Partial de 20260801060000_AddFnSeguimientoDiarioProduccion: SQL verbatim de la fn v1.
// SQL sincronizado con backend/sql/fn_seguimiento_diario_produccion.sql (fuente canonica
// con el changelog). Mantener ese doble asiento en cada version nueva (patron engorde).

namespace ZooSanMarino.Infrastructure.Migrations
{
    public partial class AddFnSeguimientoDiarioProduccion
    {
        private const string FnSeguimientoDiarioProduccionV1 = """
-- ═══════════════════════════════════════════════════════════════════════════════════════
