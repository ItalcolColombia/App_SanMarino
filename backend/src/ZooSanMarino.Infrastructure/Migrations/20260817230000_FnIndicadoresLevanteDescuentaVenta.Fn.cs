// Partial de la migracion FnIndicadoresLevanteDescuentaVenta: SOLO las dos constantes SQL de
// fn_indicadores_levante_postura (la nueva para Up, la anterior para Down). Viven separadas para
// que el archivo principal se pueda leer. La nueva es backend/sql/fn_indicadores_levante_postura.sql
// tal cual, y la anterior esta copiada VERBATIM de HEAD (ni una linea tocada).

#nullable disable

namespace ZooSanMarino.Infrastructure.Migrations
{
    public partial class FnIndicadoresLevanteDescuentaVenta
    {
        /// <summary>Con la venta descontada del saldo (mixto y por sexo).</summary>
        private const string FnIndicadoresLevanteConVenta = """
-- ============================================================================
...
;
        ...
        /// <summary>Cuerpo anterior VERBATIM (sin la venta), para el Down().</summary>
        private const string FnIndicadoresLevanteSinVenta = """
-- ============================================================================
-- fn_indicadores_levante_postura(lote_id)
-- Indicadores semanales de LEVANTE (postura Colombia) calculados en la BD.
-- Reemplaza el cómputo del front (lote-levante/tabla-lista-indicadores +
