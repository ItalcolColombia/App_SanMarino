...
{
    /// <summary>
    /// R1b: "Total kilos despachados a cliente" SIEMPRE se muestra en la Liquidación Técnica Pollo
    /// Engorde EC. Sin merma en kilos => = kg_carne (antes salía NULL/vacío); con merma, aritmética
    /// intacta (kg_carne - merma_kilos). CREATE OR REPLACE idempotente; espejo exacto de
    /// backend/sql/fn_indicadores_pollo_engorde.sql. Down restaura la versión previa.
    /// </summary>
    public partial class UpdateFnIndicadoresPolloEngordeTotalDespachadosSinMerma : Migration
    {
        /// <inheritdoc />
