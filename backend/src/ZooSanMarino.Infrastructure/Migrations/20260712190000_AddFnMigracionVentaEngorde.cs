...
{
    /// <inheritdoc />
    public partial class AddFnMigracionVentaEngorde : Migration
    {
        // Registra la función de migración masiva de VENTAS de pollo de engorde.
        // CREATE OR REPLACE → idempotente; se aplica sola en cada deploy.
        // Fuente canónica: backend/sql/fn_migracion_venta_engorde.sql.
...
");
        ...
        {
            migrationBuilder.Sql("DROP FUNCTION IF EXISTS public.fn_migracion_venta_engorde(integer, integer, jsonb);");
        }
    }
}
