// Partial de la migracion FnSeguimientoEngordeV15AperturaVisibleYMarcaCiclo: SOLO las dos
// constantes SQL de fn_seguimiento_diario_engorde (v15 para Up, v14 para Down). Viven separadas
// para que el archivo principal se pueda leer. La v14 esta copiada VERBATIM de la migracion
// 20260808010000 (ni una linea tocada) y la v15 es backend/sql/fn_seguimiento_diario_engorde.sql
// tal cual.
...
{
    public partial class FnSeguimientoEngordeV15AperturaVisibleYMarcaCiclo
    {
        /// <summary>
        /// v15 - dos columnas ADITIVAS al final del RETURNS TABLE (`apertura_alimento_kg` y
        /// `apertura_documentos`, pobladas solo en la primera fila del ciclo) + override por la marca
        /// `para_proximo_ciclo` del historico unificado. Resto del cuerpo v14 VERBATIM.
        /// Empieza con DROP FUNCTION porque la firma cambia: PostgreSQL no deja agregar columnas OUT
        /// con CREATE OR REPLACE ("cannot change return type of existing function").
        /// </summary>
        private const string FnSeguimientoDiarioEngordeV15 = """
-- =============================================================================
...
""";
        ...
        /// <summary>
        /// v14 VERBATIM (migracion 20260808010000), para el Down. Va precedida de un DROP FUNCTION en
        /// el Down() porque volver de 48 a 46 columnas OUT tambien cambia el tipo de retorno.
        /// </summary>
        private const string FnSeguimientoDiarioEngordeV14 = """
-- =============================================================================
-- fn_seguimiento_diario_engorde(p_lote_id INT)
-- Devuelve la tabla diaria de seguimiento de un lote de pollo engorde.
-- Tabla fuente: seguimiento_diario_aves_engorde
