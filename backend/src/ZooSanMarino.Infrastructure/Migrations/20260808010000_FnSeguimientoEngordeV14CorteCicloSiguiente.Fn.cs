// Partial de la migracion FnSeguimientoEngordeV14CorteCicloSiguiente: SOLO las dos constantes SQL de
// fn_seguimiento_diario_engorde (v14 para Up, v13 para Down). Viven separadas para que el archivo
// principal se pueda leer. La v13 esta copiada VERBATIM de la migracion 20260731185300 (ni una linea
// tocada) y la v14 es backend/sql/fn_seguimiento_diario_engorde.sql tal cual.

#nullable disable

namespace ZooSanMarino.Infrastructure.Migrations
{
    public partial class FnSeguimientoEngordeV14CorteCicloSiguiente
    {
        /// <summary>
        /// v14 â€” `fecha_max` se acota tambien al dia previo al arranque del ciclo SIGUIENTE del
        /// galpon (CTE `corte_ciclo_siguiente`). Criterio ESTRUCTURAL â€”otro lote ya tiene
        /// seguimiento ahiâ€” y no numerico, asi que funciona aunque el lote haya quedado en
        /// `Abierto` sin liquidar y su saldo nunca toque 0. Resto del cuerpo v13 VERBATIM.
        /// </summary>
...
""";
        ...
        /// <summary>v13 VERBATIM (migracion 20260731185300): la usa el Down.</summary>
