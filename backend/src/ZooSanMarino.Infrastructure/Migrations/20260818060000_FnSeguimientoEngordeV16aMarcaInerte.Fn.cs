// Partial de la migracion FnSeguimientoEngordeV16aMarcaInerte: SOLO las dos constantes SQL de
// fn_seguimiento_diario_engorde (v16a para el Up, v15 para el Down). Viven separadas para que el
// archivo principal se pueda leer. La v16a es backend/sql/fn_seguimiento_diario_engorde.sql tal
// cual, y la v15 esta copiada VERBATIM de la migracion 20260808130000 (ni una linea tocada).

#nullable disable

namespace ZooSanMarino.Infrastructure.Migrations
{
    public partial class FnSeguimientoEngordeV16aMarcaInerte
    {
        /// <summary>
        /// v16a - la marca `para_proximo_ciclo` deja de interpretarse: se van el disyunto marcado de
        /// `apert_mov` y los 4 guards de `hist_full`, `hist_alimento`, `docs_por_fecha` y
        /// `fechas_universo`. Se CONSERVAN `apertura_alimento_kg` y `apertura_documentos` (parte A de
        /// la v15), asi que la firma sigue teniendo 49 columnas OUT y no hace falta DROP: el script
        /// igual lo trae, por idempotencia, tal como esta en backend/sql/.
        /// </summary>
        private const string FnSeguimientoDiarioEngordeV16a = """
-- =============================================================================
...
""";
        ...
        /// <summary>
        /// v15 VERBATIM (migracion 20260808130000), para el Down. Misma firma que la v16a, asi que el
        /// DROP del propio script alcanza y no hace falta ninguno extra.
        /// </summary>
