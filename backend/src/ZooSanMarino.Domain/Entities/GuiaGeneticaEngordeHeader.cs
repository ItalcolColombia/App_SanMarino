...
/// </summary>
public class GuiaGeneticaEngordeHeader : AuditableEntity
{
    ...
    public virtual ICollection<GuiaGeneticaEngordeDetalle> Detalles { get; set; } = new List<GuiaGeneticaEngordeDetalle>();
}
