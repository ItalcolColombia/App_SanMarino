...
/// </summary>
public class GuiaGeneticaEngordeDetalle : AuditableEntity
{
    public int Id { get; set; }

    public int GuiaGeneticaEngordeHeaderId { get; set; }
    public virtual GuiaGeneticaEngordeHeader GuiaGeneticaEngordeHeader { get; set; } = null!;
