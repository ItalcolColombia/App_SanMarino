...
/// <summary>
/// Seguimiento diario por lote aves de engorde (Panamá). Tabla: seguimiento_diario_aves_engorde_panama.
/// Un registro por lote_ave_engorde_id por fecha.
/// Incluye campos adicionales para Panamá: cantidad de alimento por categoría (quintales).
/// </summary>
public class SeguimientoDiarioAvesEngordePanama
{
    ...
    /// <summary>
    /// Campos específicos de Panamá para seguimiento de alimento
    /// </summary>
