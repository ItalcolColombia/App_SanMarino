// src/ZooSanMarino.Application/DTOs/IndicadorEngordeDto.cs
namespace ZooSanMarino.Application.DTOs;

/// <summary>
/// DTO para solicitar cálculo de indicadores de Ecuador
/// </summary>
public record IndicadorEngordeRequest(
    int? GranjaId = null,
...
/// </summary>
public record IndicadorEngordeDto(
    // Identificación
    int GranjaId,
    string GranjaNombre,
    int? LoteId,
...
public record LiquidacionPeriodoDto(
    ...
    IEnumerable<IndicadorEngordeDto> Indicadores
);
...
/// </summary>
public record IndicadorReproductorDto(int Id, string NombreLote, IndicadorEngordeDto Indicador);
...
public record IndicadorPolloEngordePorLotePadreDto(
    IndicadorEngordeDto? IndicadorLotePadre,
...
/// </summary>
public record IndicadorEngordeConsolidadoDto(
    ...
    // Detalle por granja
    IEnumerable<IndicadorEngordeDto> IndicadoresPorGranja,
