// src/ZooSanMarino.Application/Interfaces/IIndicadorEngordeService.cs
...
/// </summary>
public interface IIndicadorEngordeService
{
    /// <summary>
    /// Calcula indicadores para lotes activos o cerrados según filtros
    /// </summary>
    Task<IEnumerable<IndicadorEngordeDto>> CalcularIndicadoresAsync(IndicadorEngordeRequest request);
    
    /// <summary>
    /// Calcula indicadores consolidados de todas las granjas
    /// </summary>
    Task<IndicadorEngordeConsolidadoDto> CalcularConsolidadoAsync(IndicadorEngordeRequest request);
    ...
    /// </summary>
    Task<IEnumerable<IndicadorEngordeDto>> ObtenerLotesCerradosAsync(
        DateTime fechaDesde,
        DateTime fechaHasta,
        int? granjaId = null,
