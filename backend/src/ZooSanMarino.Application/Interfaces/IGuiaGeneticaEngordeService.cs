...
public interface IGuiaGeneticaEngordeService
{
    Task<GuiaGeneticaEngordeFiltersDto> GetFiltersAsync(CancellationToken ct = default);
    ...
    Task<IEnumerable<GuiaGeneticaEngordeDetalleDto>> GetDatosAsync(string raza, int anioGuia, string sexo, CancellationToken ct = default);
    ...
    Task<GuiaGeneticaEngordeImportResultDto> ImportExcelAsync(IFormFile file, string raza, int anioGuia, string estado, CancellationToken ct = default);

    Task<GuiaGeneticaEngordeHeaderDto> UpsertManualAsync(GuiaGeneticaEngordeManualRequestDto request, CancellationToken ct = default);
}
